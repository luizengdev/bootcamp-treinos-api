...
- Use Vercel AI SDK (v7) — `tool`, `stepCountIs`, `streamText`, `convertToModelMessages` do pacote `ai`
- Use `inputSchema` (não `parameters`) na definição das tools (API do AI SDK v7)
